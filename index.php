...
<body class="bg-white dark:bg-slate-600 flex justify-center items-center h-screen">
    <div class="text-center z-10">
        <h2 class="text-4xl text-white font-semibold mb-6">
            Store Your Bookmarks Easily with Booklist
        </h2>
